  ...
  return (
    <article className="container_project">
      ...
      <div className="contenedor">
        <a href="https://ecommerce-electronic-shop.netlify.app/" target="_blank" className="figure">
          <img
        ...
        <a href="https://wheather-app-location.netlify.app/" target="_blanñ" className="figure">
          <img
        ...
        <a href="https://pokedex-actual.netlify.app/" target="_blank" className="figure">
          <img
        ...
        <a href="https://users-generation.netlify.app/" target="_blank" className="figure">
          <img
            src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh-TSl6Xox0nPqCKY1STHQ12ME7kofO6pqE7AB6BCJFlxaF9Cem_493a8ymwAwtcXRZJDffdwSJ1p8f9Lsp9R3-oazof4t3GcX_mIna71A40TZvcaIqXPcQ1lq7enkW1IW0G0RcJb0im9AFEzO5OztoT3ficc_8egizFCbXAwicmHe3qFgqf-LeeTHCCg/s792/users2.PNG"
            alt=""
          />
