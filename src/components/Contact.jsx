...
const Contact = ({theme}) => {
  ...
  return (
    <section className="containerContact_principal">
      ...
      <a id={theme} href="https://www.linkedin.com/in/eloy-sandoval-bba76115b/" target="_blank">
      ...
      <a id={theme} href="https://www.instagram.com/eloy_sandoval82/" target="_blank">
        <i  className="iconos bx bxl-instagram-alt"></i>
      </a>
      <a id={theme} href="https://www.facebook.com/eloy.sandoval.7564/" target="_blank">
